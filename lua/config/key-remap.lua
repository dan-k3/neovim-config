...
-- LSP shortcuts
vim.keymap.set("i", "<C-Space>", "<C-x><C-o>", {noremap = true, silent = true, desc = "Trigger LSP Completion"})
vim.keymap.set("i", "<C-@>", "<C-x><C-o>", {noremap = true, silent = true, desc = "Trigger LSP Completion"})
